...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //MY GUESS FOR MY SETTINGS (MATT): __ __ __ / 11 2 5 (or 11 25 2) / 6 2 3 (or 6 23 12 or 0 6 23)
        char[] ciphertext = "BQHFCIXQSGVSKVTJSPCYRPQNFEEZGAXHEZXWPKMVJAZECRGVPYNKSUFEWFABQDKDFVBXNDXBCBFQMACFQHXVCZKKRJCRGXPMGRHYAZEQGJBWYLMPFVNXF".toCharArray();
